...
namespace NVRCsharpDemo
{
    ...
    public partial class MultiScreenWindow : Form
    {
        ...
        private void CreateMultiScreen()
        {
            Point[] xy;
            Size[] wh;
            int channel = 4;
            ...
            {
                this.tabPage1.Controls.Add(CreatePanel(xy[i], wh[i], i));
            }
